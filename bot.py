...
def balance(bot, message):
  try:
    ...
    view = driver.find_element_by_xpath("//div[3]//div[1]//div[1]//div[1]//div[1]//div[1]//span[1]").text
    view2 = view.replace(" ","")
    balance = driver.find_element_by_xpath('//div[3]//div[2]//div[1]//div[1]//div[1]//div[1]//span[1]').text
    name = driver.find_element_by_xpath("//div[@class='profile-name']").text 
    date = driver.find_element_by_xpath("//div[3]//div[1]//div[1]//div[1]//p[1]//span[2]").text
    avg_cpm = driver.find_element_by_xpath("//div[3]//div[4]//div[1]//div[1]//div[1]//div[1]//span[1]").text
    ref_earn = driver.find_element_by_xpath("//div[3]//div[3]//div[1]//div[1]//div[1]//div[1]//span[1]").text
    tbalance = driver.find_element_by_xpath("//span[normalize-space()='Payments']").click()
    time.sleep(3)
    total_balance = driver.find_element_by_xpath("/html[1]/body[1]/div[1]/div[1]/section[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/h6[1]").text
...
#   if str(email) in file_contents:
    ...
    sign = driver.find_element_by_xpath('//*[@id="invisibleCaptchaSignin"]').click()
    name = driver.find_element_by_xpath("//div[@class='profile-name']").text
    referral = driver.find_element_by_xpath("//a[@href='/member/users/referrals']").click()
    referrallink = driver.find_element_by_xpath("/html[1]/body[1]/div[1]/div[1]/section[1]/div[2]/div[1]/pre[1]").text
    print(referrallink)
